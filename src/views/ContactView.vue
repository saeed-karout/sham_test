<template>
    <form action="https://fabform.io/f/xxxxx" method="post" class="mt-10">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 grid-cols-1">
                                ...
                                <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div class="bg-white rounded-lg p-6 block">
                                        ...
                                        <a href="javascript:;" class="flex items-center">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">
                                              Saudi Arabia, arid, sparsely populated</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                        <h2 class=" font-manrope text-4xl font-semibold leading-10 mb-11" style="color: #B38E60;">Send Us A
                            Message</h2>
                        <input type="text"
                        ...
                        <div class="mb-10">
                            <h4 class="text-gray-500 text-lg font-normal leading-7 mb-4">Preferred method of
                                communication</h4>
                            <div class="flex">
                                <div class="flex items-center mr-11 opacity-50">
                                    ...
                                    <input type="radio" for="radio-group-2" class="border border-gray-300 rounded-full mr-2 w-4 h-4  ml-2"/>
                        ...
                        <input type="text"
                            ...
                            placeholder="Message">
                        <button
                            class="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-indigo-800 shadow-sm" style="background-color: #314351; color: #B38E60;">Send</button>
                    </div>
                </div>
            </div>
        </section>
