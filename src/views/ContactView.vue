            ...
            <section class="py-20">
                ...
                <div class="mx-auto max-w-7xl mt-5 px-4 sm:px-6 lg:px-8">
                    <div class="grid lg:grid-cols-2 grid-cols-1 ">
                        <div class="lg:mb-5">
                            <div
                                class="group w-full h-full min-h-[350px] bg-gray-200 rounded-2xl overflow-hidden relative">
                                ...
                                <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div class="bg-white rounded-lg p-6 shadow-lg">
                                        <a href="javascript:;" class="flex items-center mb-6">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">+966 000 000
                                            </h5>
                                        </a>
                                        ...
                                        <a href="javascript:;" class="flex items-center">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">
                                                Saudi Arabia, arid, sparsely populated
                                            </h5>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="bg-gray-50 p-5 lg:p-11  rounded-2xl dark:bg-gray-800 dark:opacity-80">
                            <h2 class="text-4xl font-semibold leading-10 mb-12" style="color: #B38E60;">Send Us A
                                Message</h2>
                           ...
                           <div class="mt-24">
                             ...
                             <textarea cols="6" rows="4"
                                 class="w-full h-32 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-4 rounded-3xl border border-gray-200 focus:outline-none pl-4 mb-6"
                                 placeholder="Message"></textarea>
                            
                             <button
                                 class="w-full h-14 text-white text-base font-semibold leading-6 rounded-full bg-slate-700 transition-all duration-700 hover:bg-[#A9947E] hover:text-[#1F2937] shadow-sm">
                                 Send
                             </button>
                           </div>
                        </div>
