          ...
          <div class="mx-auto max-w-7xl border-t dark:border-yellow-500 border-gray-200 px-4 sm:px-6 lg:px-8">
              ...
              <div class="flex justify-between flex-col py-8 min-[500px]:py-14 gap-8 min-[500px]:gap-16 lg:gap-0 lg:flex-row">
                  ...
                  <div class="block lg:max-w-md">
                      ...
                      <div
                          ...
                          <button type="submit"
                              class="py-3.5 px-7  shadow-md rounded-full font-semibold hover:bg-indigo-700" style="background-color: #314351; color: #B99261;">Subscribe</button>
                      </div>
                  </div>
              </div>
              <div class="py-9 border-t dark:border-yellow-500 border-gray-200">
                  <div class="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
                      <span class="text-sm text-gray-500 ">&copy;<a href="https://www.shamnet.com.sa/">S.N.C Contracting</a> 2024, All rights reserved.</span>
                      <div class="flex mt-4 space-x-4 sm:justify-center sm:mt-0 ">
                          ...
                          <a href="javascript:;"
                              class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                              <svg class="w-[1.25rem] h-[1.125rem] " style="color: #B99261;" viewBox="0 0 15 15" fill="none"
                          ...
                          <a href="javascript:;"
                              class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                              <svg class="w-[1rem] h-[1rem] " style="color: #B99261;" viewBox="0 0 13 12" fill="none"
                                  xmlns="http://www.w3.org/2000/svg">
                                  <path
                          ...
                          <a href="javascript:;"
                              class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                              <svg class="w-[1.25rem] h-[0.875rem] " style="color: #B99261;" viewBox="0 0 16 12" fill="none"
                                  xmlns="http://www.w3.org/2000/svg">
