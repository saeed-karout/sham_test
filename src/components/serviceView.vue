         ...
         methods: {
             async fetchFeatures() {
                 try {
                     ...
                     this.features = data.products; // Adjust according to the API response structure
                 } catch (error) {
         ...
         <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
             ...
             <div class="grid grid-cols-1 mt-10 text-center sm:mt-16  sm:grid-cols-2 md:grid-cols-3 xl:mt-24 ">
                 ...
                 <div v-for="feature in features" :key="feature.id"
                     ...
                     <Fwb-card img-alt="Desk" class="flex flex-col justify-center items-center " img-src="https://flowbite.com/docs/images/blog/image-1.jpg" variant="image">
 ...
 <style scoped>
     /* Add border only between grid items */
     .grid {
         display: grid;
     }
